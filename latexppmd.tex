...
% v.3 sept. 2016-2020, J. Beilin, modification de la gestion de la biblio + modifs mineures 
%----------------------------------------------------------------
...
\textit{{\color{red}Choisir les intitulés et responsables pédagogiques (p2) qui conviennent suivant votre cursus - ing3 ou mastère spécialisé -}}

\maketitle{{\color{red}Rapport de stage} ou {\color{magenta}Thèse Professionnelle}\\{\color{red}Cycle des ingénieurs de l'ENSG 3\up{ème} année} ou {\color{magenta}Mastère spécialisé XXX}}{images/image_couverture}


\infos{\author}{Septembre 2023}
